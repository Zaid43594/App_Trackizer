...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  Widget buildGeneralSection() {
    return buildCard([
      buildSettingItem(
          "Security", controller.securityMethod as String, 'assets/images/FaceID.png'),
      buildSwitchItem("iCloud Sync", controller.iCloudSync as bool, (value) {
        setState(() {
  ...
  Widget buildSubscriptionsSection() {
    return buildCard([
      buildSettingItem(
          "Sorting", controller.sortingMethod as String, 'assets/images/Sorting.png'),
      buildSettingItem(
          "Summary", controller.summaryType as String, 'assets/images/Chart.png'),
      buildSettingItem(
          "Default currency", controller.defaultCurrency as String, 'assets/images/Money.png'),
    ]);
  }

  Widget buildAppearanceSection() {
    return buildCard([
      buildSettingItem("App icon", controller.appIcon as String, 'assets/images/App icon.png'),
      buildSettingItem("Theme", controller.themeMode as String, Icons.light_mode_outlined),
    ]);
  }
