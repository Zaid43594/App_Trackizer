...
class CalendarController {
  List<DayModel> getDays() {
    return [
      DayModel(day: "01", label: "Mon", isActive: false),
      DayModel(day: "02", label: "Tue", isActive: false),
      DayModel(day: "03", label: "Wed", isActive: true),
  ...
  List<Map<String, dynamic>> getSubscriptions() => [
        {'name': 'Spotify', 'price': '55.99 SP', 'image': ImagePaths.spotify},
        {'name': 'YouTube', 'price': '29.99 SP', 'image': ImagePaths.youtube},
        {
          'name': 'MicroSoft',
          'price': '99.00 SP',
